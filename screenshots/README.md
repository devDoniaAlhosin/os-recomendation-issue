...
Images used by `docs/reports/OS-AGENCY-INTERNAL-RECOMMENDATIONS.html`.

| File | Linked to |
|------|-----------|
| `ISS-001.png` | Lead Console visible to MEMBER |
| `ISS-003.png` | Status Phase dropdown does not open |
| `ISS-007.png` | Client edit menu clipped / MEMBER can edit |
